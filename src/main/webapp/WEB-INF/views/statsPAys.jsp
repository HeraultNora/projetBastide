<%-- 
    Document   : statsPAys
    Created on : 10 mai 2020, 18:26:54
    Author     : midor
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function drawPiechart(result) {
                ...
                var options = {title: 'Représentation du chiffre d affaires par pays'};
            ...
            function doAjax() {
                $.ajax({
                    url: "mvc/service/unitesVendues/pays",
                    dataType: "json",
    ...
    <body>
        <h1>Chiffre d'affaires par pays</h1>
        <!-- Le graphique apparaît ici -->
        <div id="piechart" style="width: 900px; height: 500px;"></div>
        <hr>
        <a href='mvc/service/unitesVendues/pays' target="_blank">Voir les données brutes (JSON)</a>
        <hr>
